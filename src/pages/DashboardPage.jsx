...
function DashboardPage() {
  const { bills, monthlyIncome, setMonthlyIncome, incomeMode, setIncomeMode, trackedMonthlyIncome, effectiveMonthlyIncome, userName, setUserName } = useBudget();
